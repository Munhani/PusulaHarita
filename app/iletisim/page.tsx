      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://www.google.com/maps?q=Karlıbayır+Mah.+Selçuklu+Cd.+No:5+D:11+Arnavutköy/İSTANBUL"
                      target="_blank"
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+90 212 597 97 00</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <DevicePhoneMobileIcon className="h-6 w-6 text-primary-600 mt-1" />
                  <div>
                    <h3 className="font-medium text-gray-900">Cep Telefonu</h3>
                    <p className="text-gray-600">+90 533 490 29 85</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">tsivri@pusulaharita.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">Çalışma Saatleri</h2>
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 font-medium">09:00 - 13:00</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Pazar</span>
                  <span className="text-gray-900 font-medium">Kapalı</span>
                </div>
              </div>
            </div>
          </motion.div>
